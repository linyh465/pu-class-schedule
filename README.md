# 🎓 靜宜大學 人工智慧應用學系 - 排課表系統 (PU Class Schedule)
...
1. **複製專案到本地**：
   ```bash
   git clone https://github.com/linyh465/pu-class-schedule.git
...
歡迎任何人工智慧應用學系的同學或開發者提供協助！如果你發現課程資料有誤、系統有 Bug，或是希望許願新功能，都非常歡迎透過提交 [Issues](https://github.com/linyh465/pu-class-schedule/issues) 或是發起 Pull Request 讓我們知道。
...
---
*Designed & Developed with ❤️ by [linyh465](https://github.com/linyh465)*
